...
class _MyAppState extends State<Agenda> {
  ...
  Widget options() => Column(
        children: [
          header("Agenda", Abi_socios.agenda_icono, context: context),
          buscador(),
          Expanded(
            child: loading
                    ...
                    child: Row(
                      children: [
                        Container(
                          width: 5,
                          height: 50,
                          color: Color.fromRGBO(82, 123, 189, 1),
                        ),
                        Expanded(
                          child: Column(
                            children: [
                              Container(
                                ...
                                width: double.infinity,
                                child: Text(_searchList[i].nombrePersona),
                              ),
                              Container(
                                margin: EdgeInsets.only(left: 5),
                                width: double.infinity,
  ...
  void buildSearchList(String text) {
    if (text != "") {
      final list = events
          .where((e) =>
              e.nombrePersona.toLowerCase().contains(text.toLowerCase()) ||
              e.producto.toLowerCase().contains(text.toLowerCase()))
          .toList();
      if (list.isNotEmpty) {
